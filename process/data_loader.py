...
class InputFeatures(object):
    ...
    def __init__(self, word_ids, char_ids, img_feature,dns_feature, mask, label_ids,token_ids):
...
def load_data(args, mode):
    ...
    all_token_ids = torch.stack([f.token_ids for f in features], dtype=torch.long).to(device)
    ...
    dataset = TensorDataset(all_word_ids, all_char_ids, all_img_feature,all_dns_feature, all_mask, all_label_ids,all_token_ids)
    #device = "cuda" if torch.cuda.is_available() and not args.no_cuda else "cpu"
    return dataset
